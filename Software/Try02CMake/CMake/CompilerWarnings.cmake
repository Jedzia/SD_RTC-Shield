...
function(set_project_warnings project_name)
    ...
    option(WARNINGS_SKIP_TEMPORARY "Temporary skip warnings caused by external libraries" ON)
    ...
    elseif (CMAKE_C_COMPILER_ID MATCHES ".*Clang")
        set(PROJECT_C_WARNINGS ${CLANG_CXX_WARNINGS})
    ...
    elseif (CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
        ...
        message(AUTHOR_WARNING "No compiler warnings set for '${CMAKE_CXX_COMPILER_ID}' compiler. Ignore this warning when not using CXX.")
    endif ()

    target_compile_options(${project_name}
            INTERFACE $<$<COMPILE_LANGUAGE:C>:${PROJECT_C_WARNINGS}>
            INTERFACE $<$<COMPILE_LANGUAGE:CXX>:${PROJECT_CXX_WARNINGS}>
            )
    target_compile_definitions(${project_name} INTERFACE -DWARNINGS_SKIP_TEMPORARY)
